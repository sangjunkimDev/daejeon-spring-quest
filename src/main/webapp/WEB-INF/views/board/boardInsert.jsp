...
<div class="container-fluid">
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		...
		<div class="table-responsive">
			<form action="${pageContext.request.contextPath }/main/boardInsert"
				...
				<table class="table table-striped">
					...
					<tr>
						<th>게시글 내용</th>
						<td><textarea id="smarteditor" rows="15" cols="150"
								style="width: 766px; height: 412px;" name="board_content"></textarea></td>
					</tr>
					<tr>
						<th>첨부파일</th>
						<td></td>
